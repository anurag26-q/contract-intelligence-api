"""
Django settings for contract_intelligence project.
"""
...
MIDDLEWARE = [
    ...
    'api.middleware.PIIRedactionMiddleware',
    'api.middleware.MetricsMiddleware',
]

ROOT_URLCONF = 'contract_intelligence.urls'
...
WSGI_APPLICATION = 'contract_intelligence.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Production-ready contract analysis system with PDF ingestion, structured extraction, RAG-based Q&A, and automated risk auditing.',
    'VERSION': '1.0.0',
